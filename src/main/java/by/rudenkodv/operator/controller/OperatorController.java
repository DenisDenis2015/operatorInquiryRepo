...
public class OperatorController {
	...
	public void handleSeviceException(Exception ex, HttpServletRequest request) {
		LOGGER.error(ClassUtils.getShortName(ex.getClass()) + " throw in Controller by request : "
	...
	public @ResponseBody void updateUserInquiry(@RequestBody Inquiry inquiry,
			@PathVariable("customerName") String customerName, @PathVariable("id") long id) {
		inquiryService.saveOrUpdate(inquiry);
		LOGGER.debug("Update  inquiry by request PUT : /customers/" + inquiry.getCustomerName() + "/inquiries/"
				+ inquiry.getId());
	}
