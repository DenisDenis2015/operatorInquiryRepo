...
public class InquiryServiceMockTest{
    ...
    public void testSave() {
    	Inquiry newInquiry = new Inquiry(null, NEW_INQUIRY.getTopic(), NEW_INQUIRY.getDescription(), NEW_INQUIRY.getCreateDate(), NEW_INQUIRY.getCustomerName());
    	Mockito.doReturn(newInquiry).when(inquiryDao).insert(newInquiry);
